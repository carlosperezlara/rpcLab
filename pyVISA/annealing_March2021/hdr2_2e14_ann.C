...
int hdr2_2e14_ann() {
  ...
  sfile_2[0] = "outputfiles/20200831_HDR2-2e14-2/p10C/dark/HDR2-2e14-2-10C-dark-1.csv"; sTemp_2[0]="20200831_HDR2-2e14-2/p10C/dark/HDR2-2e14-2-10C-dark-temps-1.csv";
  sfile_2[1] = "outputfiles/fase8/outputdata_2_DARK.csv";                               sTemp_2[1]="fase8/tempdata_2_DARK.csv";
  sfile_2[2] = "outputfiles/fase9/outputdata_DARK_2.csv";                               sTemp_2[2]="20200831_HDR2-2e14-2/p10C/dark/HDR2-2e14-2-10C-dark-temps-1.csv";
  sfile_2[3] = "outputfiles/n20ish/h2e14-2/data1_DARK.csv";                             sTemp_2[3]="n20ish/h2e14-2/temp1_DARK.csv";
  sfile_2[4] = "outputfiles/n20ish/h2e14-2/data2_DARK.csv";                             sTemp_2[4]="n20ish/h2e14-2/temp2_DARK.csv";
  sfile_2[5] = "outputfiles/n20ish/h2e14-1/data3_DARK.csv";                             sTemp_2[5]="n20ish/h2e14-1/temp3_DARK.csv";
  sfile_2[6] = "outputfiles/n20ish/h2e14-1/data4_DARK.csv";                             sTemp_2[6]="n20ish/h2e14-1/temp4_DARK.csv";
  sfile_2[7] = "outputfiles/n20ish/h2e14-1/data5_DARK.csv";                             sTemp_2[7]="n20ish/h2e14-1/temp5_DARK.csv";

  sfile_1[0] = "outputfiles/20200826_HDR2-2e14/p10C/dark/HDR2-2e14-10C-dark-1.csv"; sTemp_1[0]="20200826_HDR2-2e14/p10C/dark/HDR2-2e14-10C-dark-temps-1.csv";
  sfile_1[1] = "outputfiles/fase8/outputdata_1_DARK.csv";                           sTemp_1[1]="fase8/tempdata_1_DARK.csv";
  sfile_1[2] = "outputfiles/fase9/outputdata_DARK_1.csv";                           sTemp_1[2]="20200826_HDR2-2e14/p10C/dark/HDR2-2e14-10C-dark-temps-1.csv";
  sfile_1[3] = "outputfiles/n20ish/h2e14-1/data1_DARK.csv";                         sTemp_1[3]="n20ish/h2e14-2/temp1_DARK.csv";
  sfile_1[4] = "outputfiles/n20ish/h2e14-1/data2_DARK.csv";                         sTemp_1[4]="n20ish/h2e14-2/temp2_DARK.csv";
  sfile_1[5] = "outputfiles/n20ish/h2e14-1/data3_DARK.csv";                         sTemp_1[5]="n20ish/h2e14-1/temp3_DARK.csv";
  sfile_1[6] = "outputfiles/n20ish/h2e14-1/data4_DARK.csv";                         sTemp_1[6]="n20ish/h2e14-1/temp4_DARK.csv";
  sfile_1[7] = "outputfiles/n20ish/h2e14-1/data5_DARK.csv";                         sTemp_1[7]="n20ish/h2e14-1/temp5_DARK.csv";
  
  sLegend[0] = "Oct 14th 2020";
  for(int i=1; i!=tryouts; ++i)
    sLegend[i] = Form("aft Phase %d",i+7);
  ...
  for(int istep=0; istep!=steps; ++istep) {
    ...
    for(int itry=0; itry!=tryouts; ++itry) {
      cout << sfile_1[itry].Data() << endl;
      cout << sfile_2[itry].Data() << endl;
      if(itry==0) {
  ...
  */
  ...
  TSpline3 *grFin2 = new TSpline3("spFin2",grNEWfinGEN_2[tryouts-1][4]);
