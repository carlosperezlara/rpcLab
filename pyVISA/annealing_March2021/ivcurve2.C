...
int ivcurve2(TString filelight="20200831_HDR2-2e14-2/n30C/light/HDR2-2e14-2-n30C-12mA-Orange-1.csv",
  ...
  int nlight = readfile_2( filelight, vlight, clight );
  int nref = readfile_2( fileref, vref, cref );
  ...
  // subtract reference
  subtractreference_2( nlight, vlight, clight, cref, csub );
